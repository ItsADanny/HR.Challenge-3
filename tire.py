class Tire:
    def __init__(self, type: str, health: float, max_forwards_velocity: float, max_backwards_velocity: float, max_forwards_acceleration: float, max_backwards_acceleration: float, drag: float, max_rotation_speed: float):
        self.type: str = type
